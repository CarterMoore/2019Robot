...
public class RunMotionProfile extends CommandBase {
    ...
    private enum States {FILLING, EXECUTING, FINISHED}
    ...
    private BufferedTrajectoryPointStream bufferL;
    private BufferedTrajectoryPointStream bufferR;
    ...
    public RunMotionProfile(MotionProfile profile, boolean isReversed) {
        ...
        bufferL = new BufferedTrajectoryPointStream();
        bufferR = new BufferedTrajectoryPointStream();
    ...
    protected void execute() {
        ...
        switch (state) {
            ...
            case FILLING:
                leftTalon.startMotionProfile(bufferL, 20, ControlMode.MotionProfile);
                rightTalon.startMotionProfile(bufferR, 20, ControlMode.MotionProfile);
